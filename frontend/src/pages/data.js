                        ...
                        return (
                          <tr key={index}>
                            <td className="align-middle">
                              <a href={`/projects/${projectId}/data/${datapoint.data_id}/annotate`}>
                                {datapoint.original_filename}
                              </a>
                            </td>
                            <td className="align-middle">{datapoint.number_of_segmentations}</td>
                            <td className="align-middle">{datapoint.created_on}</td>
                          </tr>
                        );
                      })}
                    </tbody>
