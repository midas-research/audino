...
class Data(models.Model):
    ...
    def get_peaks_dirname(self):
        return os.path.join(self.get_data_dirname(), "peaks")
    ...
    def get_peaks_path(self, chunk_number):
        return os.path.join(self.get_peaks_dirname(), f'{chunk_number}.json')
    ...
    def make_dirs(self):
        ...
        os.makedirs(self.get_peaks_dirname())
...
class Task(TimestampedModel):
    ...
    target_storage = models.ForeignKey('Storage', null=True, default=None,
        blank=True, on_delete=models.SET_NULL, related_name='+')
    audio_total_duration = IntArrayField(null=True, default=[])
    total_frames_count = IntArrayField(null=True, default=[])
    total_jobs_count = IntArrayField(null=True, default=[])
...
class Segment(models.Model):
    ...
    audio_file_index = models.IntegerField(null=True, blank=True, default=None)
    ...
    time_stamps = FloatArrayField(default=[], blank=True)
...
class Job(TimestampedModel):
    ...
    ai_audio_annotation_lang = models.CharField(max_length=128, default="", null=True, blank=True)
...
class TaskFlags(models.Model):
    ...
    is_gender = models.BooleanField(default=True)
    is_locale = models.BooleanField(default=True)
    is_start = models.BooleanField(default=True)
    is_end = models.BooleanField(default=True)
    is_transcription = models.BooleanField(default=True)
    is_accent = models.BooleanField(default=True)
    is_age = models.BooleanField(default=True)
    is_emotion = models.BooleanField(default=True)