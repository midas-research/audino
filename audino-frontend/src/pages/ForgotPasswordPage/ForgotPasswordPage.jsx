              ...
              <div>
                ...
                <div className="relative mt-2 rounded-md shadow-sm">
                  <input
                    ...
                    name="email"
                    id="email"
                    className={`block w-full rounded-md border-0 py-1.5 pr-10 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 !focus:outline-none ring-gray-300 placeholder:text-gray-300 focus:ring-audino-primary text-gray-900`}
                    aria-invalid="true"
