export default function AddProjectPageLoader() {
        ...
        <div role="status" className="max-w-md p-4 space-y-4 animate-pulse md:p-6 ">
            ...
            {[...Array(5).keys()].map(load =>
                <div className="" key={`addprojectloader-${load}`}>
                    <div className="h-3.5 bg-gray-300 dark:bg-audino-midnight rounded-full  w-48 mb-2.5"></div>
                    <div className="w-3/4 h-3 bg-gray-200 dark:bg-audino-midnight rounded-full mb-10"></div>
