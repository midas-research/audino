...
🚀 [Update]: We have released [audino v2.0](https://github.com/midas-research/audino/tree/main) in branch `main`. Consider checking it out and feel free to contribute. 
